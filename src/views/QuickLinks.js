...
const QuickLinks = (props) => {
  ...
  return (
    <Section
      sectionStyle="bg-slate-900"
      childStyle="transition-filter ease-in-out duration-1000 delay-100 pb-20 sm:pb-32 md:pb-40"
    >
      <div className="mt-8 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 grid sm:grid-cols-1 gap-8 lg:grid-cols-4 lg:items-center">
        ...
        <a
          href="https://github.com/tristanheilman"
          className="flex items-center justify-center space-x-2"
        >
        ...
        <a
          href="https://stackoverflow.com/users/11506005/tristan-heilman"
          className="flex items-center justify-center space-x-2"
        >
        ...
        <a
          href="https://www.linkedin.com/in/tristanheilman/"
          className="flex items-center justify-center space-x-2"
        >
