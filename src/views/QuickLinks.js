...
const QuickLinks = (props) => {
    ...
    return (
        <Section sectionStyle="bg-slate-900" childStyle='transition-filter ease-in-out duration-1000 delay-300'>
            <div className="mt-8 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 grid sm:grid-cols-1 gap-8 lg:grid-cols-4 lg:items-center pb-20 sm:pb-32 md:pb-40">
